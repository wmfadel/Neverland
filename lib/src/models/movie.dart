...
//        this.popularity = parsedJson['popularity'] ?? 0.0,
...
//        this.revenue = parsedJson['revenue'] ?? -1,
//        this.runtime = parsedJson['runtime'] ?? -1,
//        this.spoken_languages =
//            _getLanguages(parsedJson['spoken_languages']) ?? [],
//        this.status = parsedJson['status'] ?? 'Unknown',
//        this.tagline = parsedJson['tagline'] ?? '',
//        this.title = parsedJson['title'] ?? '',
//        this.vote_average = parsedJson['vote_average'] ?? 0.0,
//        this.vote_count = parsedJson['vote_count'] ?? -1;

  Movie.fromJson(Map<String, dynamic> parsedJson)
      : this.adult = parsedJson['adult'],
        this.backdrop_path = parsedJson['backdrop_path'],
        this.genres = [],
        ...
        this.spoken_languages = [],
        this.title = parsedJson['title'],
  this.vote_count = parsedJson['vote_count'].toString(),
        this.vote_average = parsedJson['vote_average'].toString();
